...
import {
  Status,
  ProviderInfo,
} from "@/components/dashboard/patients/appointments";
...
const DynamicReminders = dynamic(
  () => import("@/components/dashboard/patients/appointments/Reminders"),
  {
...
const DynamicUpcoming = dynamic(
  () => import("@/components/dashboard/patients/appointments/Upcoming"),
  {
    loading: () => <Skeleton className="h-[300px] w-full" />,
    ssr: false,
  },
...
const DynamicScheduled = dynamic(
  () => import("@/components/dashboard/patients/appointments/Scheduled"),
  {
    loading: () => <Skeleton className="h-[300px] w-full" />,
    ssr: false,
  },
...
const DynamicBooking = dynamic(
  () => import("@/components/dashboard/patients/appointments/Booking"),
  {
    loading: () => <Skeleton className="h-[300px] w-full" />,
    ssr: false,
  },
...
const DynamicHistory = dynamic(
  () => import("@/components/dashboard/patients/appointments/History"),
  {
    loading: () => <Skeleton className="h-[300px] w-full" />,
    ssr: false,
  },
...
const DynamicRatingSystem = dynamic(
  () => import("@/components/dashboard/patients/appointments/RatingSystem"),
  {
    loading: () => <Skeleton className="h-[300px] w-full" />,
    ssr: false,
  },
